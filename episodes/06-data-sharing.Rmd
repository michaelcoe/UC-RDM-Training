...
data repository that will give you a DOI or similar permanent identifier. A popular generalist repository for research data is [Figshare](https://figshare.com/). Note that there may be subject specific repositories that are a better fit for your research data. The following exercise guides you through the process of 
